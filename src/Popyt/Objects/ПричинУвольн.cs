...
namespace IIS.Popyt
{
    ...
    public class ПричинУвольн : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Popyt.ОценПричУвольн fОценПричУвольн;
        
        private IIS.Popyt.DetailArrayOfРекомендац fРекомендации;
        ...
        [PropertyStorage(new string[] {
                "ОценПричУвольн"})]
        public virtual IIS.Popyt.ОценПричУвольн ОценПричУвольн
        {
            get
            {
                ...
                IIS.Popyt.ОценПричУвольн result = this.fОценПричУвольн;
        ...
        public virtual IIS.Popyt.DetailArrayOfРекомендац Рекомендации
        {
            get
            {
                ...
                {
                    this.fРекомендации = new IIS.Popyt.DetailArrayOfРекомендац(this);
                }
                IIS.Popyt.DetailArrayOfРекомендац result = this.fРекомендации;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПричинУвольнE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПричинУвольнE", typeof(IIS.Popyt.ПричинУвольн));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПричинУвольнL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПричинУвольнL", typeof(IIS.Popyt.ПричинУвольн));
                }
            }
        }
    }
