...
CREATE INDEX Indexdbf4c2308dcafcad2f7a280147e2e3519197636b on ПричинУвольн (Специалист); 
 ...
 ALTER TABLE ПричинУвольн ADD CONSTRAINT FK027cf53e5fe163835d07bbf42e2557f2f3e0fe68 FOREIGN KEY (ОценПричУвольн) REFERENCES ОценПричУвольн; 
CREATE INDEX Index027cf53e5fe163835d07bbf42e2557f2f3e0fe68 on ПричинУвольн (ОценПричУвольн); 
...
CREATE INDEX Indexebc5f67e5e76565aafdfe0ac73eb678e90c185cc on Анкеты (Специалист); 
 ...
 ALTER TABLE ОценПричУвольн ADD CONSTRAINT FK4c28dee5f428d24dc685dfa2bc228da505fb7619 FOREIGN KEY (Анкеты) REFERENCES Анкеты; 
CREATE INDEX Index4c28dee5f428d24dc685dfa2bc228da505fb7619 on ОценПричУвольн (Анкеты); 
